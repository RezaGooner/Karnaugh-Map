...
protected:
    void closeEvent(QCloseEvent *event) override
    {
        if (!isSave) {
            ...
            msgBox.setText("آیا بدون ذخیره کردن، خارج می شوید؟");
            msgBox.setStandardButtons(QMessageBox::Yes | QMessageBox::No | QMessageBox::Cancel);
            msgBox.setDefaultButton(QMessageBox::Cancel);
            msgBox.setButtonText(QMessageBox::Yes, "خروج بدون ذخیره");
            msgBox.setButtonText(QMessageBox::No, "ماندن");
            msgBox.setButtonText(QMessageBox::Cancel, "ذخیره سازی");
            ...
            msgBox.setFont(QFont("B Kamran" , 12));
            msgBox.setWindowTitle("خروج");
            msgBox.setText("آیا خارج می شوید؟");
            msgBox.setStandardButtons(QMessageBox::Yes | QMessageBox::No);
            msgBox.setDefaultButton(QMessageBox::No);
            msgBox.setButtonText(QMessageBox::Yes, "خروج");
            msgBox.setButtonText(QMessageBox::No, "ماندن");
